...
async function getAllPosts() {
    ...
    all_posts.forEach(post => {
        async function getPostUser() {
            ...
            let comments = new Comment();
            comments = await comments.get(post.id);
            commentUsername = document.querySelector('#korisnicko_ime').value;
            ...
            document.querySelector('#allPostsWrapper').innerHTML = `<div class="single-post" data-post_id="${post.id}">
                                                                    ...
                                                                    <div class="post-actions">
                                                                        <p class="autorComment"><b>Autor: ${user.username}</b></p>
                                                                        <div>
                                                                             <button onclick="likePost(this)" class="likePostJS like-btn"><span>${post.likes}</span> Likes</button>
                                                                            <button class="comment-btn" onclick="commentPost(this)">Comments</button>
                                                                            ${delete_post_html}
                                                                    ...
                                                                    <div class="post-comments">
                                                                        <form>
                                                                            <input placeholder="Napisi komentar..." type="text">
                                                                            <button onclick="commentPostSubmit(event)" class="commentPostSubmit">Comment</button>
                                                                        </form>
                                                                        ${comments_html} 
                                                                    </div>
                                                                </div>
